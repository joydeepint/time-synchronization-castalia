...
simtime_t ApplicationPacket::getRcvTime() const
{
    return rcvTime_var;
}

void ApplicationPacket::setRcvTime(simtime_t rcvTime)
{
    this->rcvTime_var = rcvTime;
}

simtime_t ApplicationPacket::getTrsTime() const
{
    return trsTime_var;
}

void ApplicationPacket::setTrsTime(simtime_t trsTime)
{
...
int ApplicationPacketDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='r' && strcmp(fieldName, "rcvTime")==0) return base+4;
    if (fieldName[0]=='t' && strcmp(fieldName, "trsTime")==0) return base+5;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}
...
std::string ApplicationPacketDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 4: return double2string(pp->getRcvTime());
        case 5: return double2string(pp->getTrsTime());
        default: return "";
    }
}
...
bool ApplicationPacketDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 4: pp->setRcvTime(string2double(value)); return true;
        case 5: pp->setTrsTime(string2double(value)); return true;
        default: return false;
    }
}
