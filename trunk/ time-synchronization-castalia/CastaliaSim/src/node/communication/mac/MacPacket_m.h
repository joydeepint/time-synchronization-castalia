 ...
 * 	simtime_t rcvMacTime;
 * 	simtime_t trsMacTime;	
 * }
 * </pre>
 */
class MacPacket : public ::cPacket
{
  protected:
    ...
    simtime_t rcvMacTime_var;
    simtime_t trsMacTime_var;
  ...
  public:
    ...
    virtual simtime_t getRcvMacTime() const;
    virtual void setRcvMacTime(simtime_t rcvMacTime);
    virtual simtime_t getTrsMacTime() const;
    virtual void setTrsMacTime(simtime_t trsMacTime);
};
