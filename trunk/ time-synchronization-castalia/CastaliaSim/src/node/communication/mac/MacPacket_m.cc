...
simtime_t MacPacket::getRcvMacTime() const
{
    return rcvMacTime_var;
}

void MacPacket::setRcvMacTime(simtime_t rcvMacTime)
{
    this->rcvMacTime_var = rcvMacTime;
}

simtime_t MacPacket::getTrsMacTime() const
{
    return trsMacTime_var;
}

void MacPacket::setTrsMacTime(simtime_t trsMacTime)
{
