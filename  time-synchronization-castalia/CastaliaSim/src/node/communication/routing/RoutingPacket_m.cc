...
RoutingPacket::RoutingPacket(const char *name, int kind) : cPacket(name,kind)
{
    ...
    this->rcvMacTime_var = 0;
    this->trsMacTime_var = 0;
}
...
void RoutingPacket::copy(const RoutingPacket& other)
{
    ...
    this->rcvMacTime_var = other.rcvMacTime_var;
    this->trsMacTime_var = other.trsMacTime_var;
}
...
void RoutingPacket::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->rcvMacTime_var);
    doPacking(b,this->trsMacTime_var);
}
...
void RoutingPacket::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->rcvMacTime_var);
    doUnpacking(b,this->trsMacTime_var);
}
...
simtime_t RoutingPacket::getRcvMacTime() const
{
    return rcvMacTime_var;
}

void RoutingPacket::setRcvMacTime(simtime_t rcvMacTime)
{
    this->rcvMacTime_var = rcvMacTime;
}

simtime_t RoutingPacket::getTrsMacTime() const
{
    return trsMacTime_var;
}

void RoutingPacket::setTrsMacTime(simtime_t trsMacTime)
{
    this->trsMacTime_var = trsMacTime;
}
...
int RoutingPacketDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='r' && strcmp(fieldName, "rcvMacTime")==0) return base+4;
    if (fieldName[0]=='t' && strcmp(fieldName, "trsMacTime")==0) return base+5;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}
...
std::string RoutingPacketDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 4: return double2string(pp->getRcvMacTime());
        case 5: return double2string(pp->getTrsMacTime());
        default: return "";
    }
}
...
bool RoutingPacketDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 4: pp->setRcvMacTime(string2double(value)); return true;
        case 5: pp->setTrsMacTime(string2double(value)); return true;
        default: return false;
    }
}
